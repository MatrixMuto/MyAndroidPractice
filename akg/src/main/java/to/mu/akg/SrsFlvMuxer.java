...
import com.github.faucamp.simplertmp.RtmpPublish;
...
//    }
     ...
     * @param handler the rtmp event handler.
     */
    public SrsFlvMuxer(DefaultRtmpPublisher publisher) {
...
//            publisher.publish("live");
    ...
    private void sendFlvTag(SrsFlvFrame frame) throws IllegalStateException, IOException {
        ...
        if (frame.is_video()) {
            publisher.send(frame.tag.data.array(), 0, 1);
//                    (frame.tag.data.array());
